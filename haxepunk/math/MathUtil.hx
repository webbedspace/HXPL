...
class MathUtil
{
	 ...
	 */
	public static function stepTowards(object:XY, x:Float, y:Float, distance:Float = 1)
	{
		point.x = x - object.x;
		point.y = y - object.y;
	 ...
	 */
	public static inline function anchorTo(object:XY, anchor:XY, distance:Float = 0)
	{
	 ...
	 * @param	y			Y offset.
	 */
	public static inline function angleXY(object:XY, angle:Float, length:Float = 1, x:Float = 0, y:Float = 0)
	{
		angle *= RAD;
	 ...
	 */
	public static inline function rotateAround(object:XY, anchor:XY, angle:Float = 0, relative:Bool = true)
	{
	 ...
	 */
	public static inline function clampInRect(object:XY, x:Float, y:Float, width:Float, height:Float, padding:Float = 0)
	{
